...
export default function NavMenu() {
  ...
  const onSelect = (code: SetStateAction<string>) => setSelect(code);
  ...
  return (
    <div className="">
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="staticy z-40 lg:show" onClose={setOpen}>
          <Transition.Child
            as={Fragment}
          ...
          <div className=" border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                {/* <div>
                  <button className={Style.sign_btn}>Sign Up/Login</button>
                </div> */}
              </div>
            </div>
          </div>
